...
if (DEV_MODE) { ?>
<?php } else { ?>
        <!-- <script src="<?=WEB_PATH?>/js/oauth_fb.lib.min.js" type="text/javascript"></script> -->
<?php } ?>
<?php // leave file path as plain text (rather than php var) for better gen_js.py parsing
if (DEV_MODE) { ?>
        ...
        <script src="<?=toggle_min_script(WEB_PATH.'/js/oauth_fb.js')?>" type="text/javascript"></script>
<?php } else { ?>
        <script src="<?=WEB_PATH?>/js/oauth_fb.pack.min.js" type="text/javascript"></script>
<?php } ?>
        <?php
