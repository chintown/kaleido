...
if (DEV_MODE) { ?>
<?php } else { ?>
        <script src="<?=WEB_PATH?>/js/lookdown.lib.min.js" type="text/javascript"></script>
<?php } ?>
<?php // leave file path as plain text (rather than php var) for better gen_js.py parsing
if (DEV_MODE) { ?>
        ...
        <script src="<?=toggle_min_script(PARENT_WEB_PATH.'/js/common.3d.js')?>" type="text/javascript"></script>
        <script src="<?=toggle_min_script(WEB_PATH.'/js/common.project.js')?>" type="text/javascript"></script>
        <script src="<?=toggle_min_script(WEB_PATH.'/js/lookdown.js')?>" type="text/javascript"></script>
<?php } else { ?>
        <script src="<?=WEB_PATH?>/js/lookdown.pack.min.js" type="text/javascript"></script>
<?php } ?>
        <?php
